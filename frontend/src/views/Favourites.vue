<template>
    <div id='Home'>
        ...
        <main>
            ...
            <section id="dimness" ref="dimness" />
        ...
        methods: {
            showBooks(bookList){
                for (let bookData of bookList) {
                    ...
                    bookElement.$el.addEventListener('click', () => {
                        let book = new (Vue.extend(bookContentContainer))();
                        book.$props.id = bookData.id;
                        book.$props.title = bookData.title;
                        book.$props.description = bookData.description;
                        book.$props.genre = bookData.genre;
                        book.$props.author = bookData.author;
                        book.$props.cover = bookData.cover;
                        book.$mount()
                        this.$refs.dimness.appendChild(book.$el)
